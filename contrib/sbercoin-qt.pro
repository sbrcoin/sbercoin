...
RESOURCES += src/qt/sbercoin.qrc src/qt/sbercoin_locale.qrc

TRANSLATIONS += src/qt/locale/sbercoin_bg.ts \
                src/qt/locale/sbercoin_de.ts \
                src/qt/locale/sbercoin_en.ts \
                src/qt/locale/sbercoin_es.ts \
                src/qt/locale/sbercoin_fi.ts \
                src/qt/locale/sbercoin_fr.ts \
                src/qt/locale/sbercoin_it.ts \
                src/qt/locale/sbercoin_ja.ts \
                src/qt/locale/sbercoin_pl.ts \
                src/qt/locale/sbercoin_pt.ts \
                src/qt/locale/sbercoin_ru.ts \
                src/qt/locale/sbercoin_sk.ts \
                src/qt/locale/sbercoin_sv.ts \
                src/qt/locale/sbercoin_vi.ts \
                src/qt/locale/sbercoin_zh_CN.ts \
                src/qt/locale/sbercoin_zh_TW.ts
