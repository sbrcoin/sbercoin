Contributing to sbercoin Core
============================

The sbercoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the sbercoin Core project, and is not to be
confused with overall sbercoin Network Protocol consensus changes.

Whether a pull request is merged into sbercoin Core rests with the project merge
...
Patches that change sbercoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the sbercoin consensus, it must have been
...
The project leader is the release manager for each sbercoin Core release.
