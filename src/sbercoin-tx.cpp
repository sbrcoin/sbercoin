...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("sbercoin Core sbercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sbercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sbercoin transaction") + "\n" +
                               "  sbercoin-tx [options] -create [commands]   " + _("Create hex-encoded sbercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sbercoin transaction
