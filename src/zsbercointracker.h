...
#ifndef sbercoin_ZsbercoinTRACKER_H
#define sbercoin_ZsbercoinTRACKER_H
...
public:
    CzsbercoinTracker(std::string strWalletFile);
    ~CzsbercoinTracker();
...
#endif //sbercoin_ZsbercoinTRACKER_H
