...
public:
    ...
    bool WriteZsbercoinSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZsbercoinSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZsbercoinSeed_deprecated(uint256& seed);
    bool EraseZsbercoinSeed();
    bool EraseZsbercoinSeed_deprecated();

    bool WriteZsbercoinCount(const uint32_t& nCount);
    bool ReadZsbercoinCount(uint32_t& nCount);
