...
#ifndef sbercoin_ZsbercoinWALLET_H
#define sbercoin_ZsbercoinWALLET_H
...
public:
    CzsbercoinWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZsbercoin(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZsbercoin(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //sbercoin_ZsbercoinWALLET_H
