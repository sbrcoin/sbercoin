...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("sbercoin Core"),
     ...
     * override -datadir in the sbercoin.conf file in the default data directory
     * (to be consistent with sbercoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
