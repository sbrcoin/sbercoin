...
// Copyright (c) 2015-2018 The sbercoin developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzsbercoinPathCustom = GetArg("-zsbercoinbackuppath", "");
    ...
    if(!strzsbercoinPathCustom.empty()) {
        ui->wallet_customzsbercoinbackuppath->setText(QString::fromStdString(strzsbercoinPathCustom));
        ui->wallet_customzsbercoinbackuppath_label->setVisible(true);
        ui->wallet_customzsbercoinbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzsbercoinPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the sbercoin RPC console.") + "<br>" +
