...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("sbercoin Stake");
    case TransactionRecord::StakeZsbercoin:
        return tr("zsbercoin Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted sbercoin to zsbercoin");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zsbercoin");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received sbercoin from zsbercoin");
    case TransactionRecord::ZerocoinSpend_Change_zsbercoin:
        return tr("Minted Change as zsbercoin from zsbercoin Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zsbercoin to sbercoin");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zsbercoin:
        return tr("Anonymous (zsbercoin Transaction)");
    case TransactionRecord::StakeZsbercoin:
        return tr("Anonymous (zsbercoin Stake)");
    case TransactionRecord::SendToSelf:
    default:
