...
/** Utility functions used by the sbercoin Qt UI.
 */
namespace GUIUtil
{
...
// Render sbercoin addresses in monospace font
...
// Parse "sbercoin:" URI into recipient object, return true on successful parsing
