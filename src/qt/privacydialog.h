...
public:
    ...
    void setZsbercoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzsbercoin_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzsbercoin_clicked();
    void on_pushButtonZsbercoinControl_clicked();
