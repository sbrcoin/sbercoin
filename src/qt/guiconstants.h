...
/* sbercoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "sbercoin"
#define QAPP_ORG_DOMAIN "sbercoin.org"
#define QAPP_APP_NAME_DEFAULT "sbercoin-Qt"
#define QAPP_APP_NAME_TESTNET "sbercoin-Qt-testnet"
