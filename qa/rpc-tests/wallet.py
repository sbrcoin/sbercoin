...
#   c) node1 mines 32 blocks, so now node 0 has 60001sbercoin, node 1 has 4250sbercoin, node2 has none.
#   d) node0 sends 601 sbercoin to node2, in two transactions (301 sbercoin, then 300 sbercoin).
