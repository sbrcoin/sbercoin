...
In order to support loading of multiple wallets in sbercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sbercoin.cpp.
...
Changes to sbercoin.cpp
----------------------
sbercoin.cpp is the entry point into sbercoin-qt, and as such, will require some minor modifications to provide hooks for
